...
describe('Test DS18B20', ->
  ...
  it 'read values in 9  bit', -> testValues('9bit',  100)
  it 'read values in 10 bit', -> testValues('10bit', 200)
  it 'read values in 11 bit', -> testValues('11bit', 375)
